        ...
        <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md w-full border-b border-slate-200 px-4 md:px-8 py-4 ">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <nav className="space-x-4 md:space-x-8 flex justify-center items-center ">
                    <Link href="/#services"className="flex justify-center items-center rounded-full gap-2 px-3 py-2 transition-all bg-emerald-100 text-emerald-700 hover:text-slate-500"
                    aria-label="Explorar serviços">
                        <HomeIcon className="h-4 w-4" />
                        <span className="text-sm font-medium">Explorar</span>
                    </Link>
                    <Link href="/contact" className="flex justify-center items-center rounded-full gap-2 px-3 py-2 transition-all bg-white text-slate-600  hover:text-slate-600 hover:bg-slate-100"
